...
public class GestionTbDouble {
	...
	public static double[] push(double[] tb, double ajout) {
		...
		// On ajoute le double a ajouter a la fin du nouveau tableau
	 ...
	 */
	public static double[] pop(double[] tb, int indice) {
	 ...
	 */
	public static int search(double[]tb, double value) {
	...
	/**
	 * Fonction permettant de renvoyer un tableau de double depuis un tableau 
	 ...
	 */
	public static double[] slice(double[] tableau, int indiceDebut) {
	...
	/**
	 * Fonction permettant de renvoyer un tableau de double depuis un tableau original
	 ...
	 */
	public static double[] slice(double[] tableau, int indiceDebut, int indiceFin) {
	...
	public static double[][] split(double[] tableau, int indiceDecoupe) {
		...
		resultat[0] = new double[indiceDecoupe];
		resultat[1] = new double[tableau.length-resultat[0].length];
