...
public class Personnes {
    ...
    public static void verifSaisieAddBDD (){
        ...
        if (addBDD(nom, prenom, age, groupeSanguin)) {
        	System.out.println("Vous avez bien �t� enregistr� dans la base de donn�e.");
        } else {
    ...
    /**
     * Fonction permettant de r�cuperer la liste des donneurs en fonction 
     * d'un groupe danguin donner qui sera v�rifi�
     */
    ...
    /**
     * Fonction permettant de r�cuperer la liste des receveurs en fonction 
     * d'un groupe danguin donner qui sera v�rifi�
     */
    ...
    /**
     * Fonction contenant la requete Sql permettant de r�cuperer les donneurs 
    ...
    /**
     * Fonction contenant la requete Sql permettant de r�cuperer les receveurs
     * en fontion du nom du groupe sanguin
     * @param groupeSanguin
     * @return
     */
